...
$lang_module['select_payment_method'] = 'Chọn phương thức thanh toán';
$lang_module['cod'] = 'Thanh toán khi nhận hàng';
$lang_module['bank_transfer'] = 'Chuyển khoản ngân hàng';
$lang_module['credit_card'] = 'Thẻ tín dụng';
$lang_module['cod_description'] = 'Thanh toán bằng tiền mặt khi nhận hàng';
$lang_module['bank_transfer_description'] = 'Chuyển khoản qua ngân hàng';
$lang_module['card_description'] = 'Thanh toán bằng thẻ tín dụng';
$lang_module['secure_payment'] = 'Thanh toán an toàn và bảo mật';
$lang_module['place_order'] = 'Đặt hàng';
$lang_module['order_success'] = 'Đặt hàng thành công';
$lang_module['order_date'] = 'Ngày đặt hàng';
$lang_module['order_items'] = 'Sản phẩm đã đặt';
$lang_module['thank_you'] = 'Cảm ơn bạn đã đặt hàng!';
$lang_module['order_confirmation_text'] = 'Đơn hàng của bạn đã được xác nhận và đang được xử lý.';
$lang_module['contact_support'] = 'Liên hệ bộ phận hỗ trợ nếu bạn có câu hỏi.';
$lang_module['view_orders'] = 'Xem đơn hàng của tôi';
...
$lang_module['total_orders'] = 'Tổng đơn hàng';
$lang_module['filtered_orders'] = 'Đơn hàng hiển thị';
$lang_module['total_amount'] = 'Tổng giá trị';
...
$lang_module['root_category'] = 'Thể loại gốc';
$lang_module['parent_category'] = 'Thể loại cha';
$lang_module['category_info'] = 'Thông tin thể loại';
$lang_module['bulk_actions'] = 'Thao tác hàng loạt';
$lang_module['select_action'] = 'Chọn hành động';
$lang_module['activate_selected'] = 'Kích hoạt đã chọn';
$lang_module['deactivate_selected'] = 'Vô hiệu hóa đã chọn';
$lang_module['delete_selected'] = 'Xóa đã chọn';
$lang_module['apply_action'] = 'Áp dụng hành động';
$lang_module['warning'] = 'Cảnh báo';
$lang_module['delete_warning_text'] = 'Hành động này không thể hoàn tác. Sách sẽ bị xóa vĩnh viễn khỏi hệ thống.';
$lang_module['back'] = 'Quay lại';
$lang_module['back_to_orders'] = 'Quay lại danh sách đơn hàng';
...
$lang_module['no_search_results'] = 'Không tìm thấy kết quả nào';
$lang_module['no_search_results_message'] = 'Không có sách nào phù hợp với từ khóa tìm kiếm của bạn.';
$lang_module['total_books'] = 'Tổng sách';
$lang_module['total_categories'] = 'Tổng thể loại';
$lang_module['total_orders'] = 'Tổng đơn hàng';
$lang_module['total_reviews'] = 'Tổng đánh giá';
$lang_module['filters'] = 'Bộ lọc';
$lang_module['inactive'] = 'Không hoạt động';
$lang_module['search_placeholder'] = 'Tìm kiếm theo tên sách...';
