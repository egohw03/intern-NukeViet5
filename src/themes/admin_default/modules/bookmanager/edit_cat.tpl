...
<div>
    <h1 style="font-size: 32px; margin: 0; color: #333;">{LANG.edit_cat}: {CAT.title}</h1>
<p style="font-size: 18px; color: #666; margin: 5px 0 0;">Chỉnh sửa thông tin thể loại</p>
</div>
</div>
...
<small style="font-size: 16px; color: #666; display: block; margin-top: 5px;">Không thể chọn thể loại con của chính nó</small>
</div>
...
<button type="submit" name="submit" style="padding: 15px 30px; background: #28a745; color: #fff; border: 2px solid #28a745; border-radius: 8px; font-size: 18px; font-weight: bold; margin-right: 15px;" <!-- BEGIN: confirm -->onclick="return confirm('{CONFIRM_MESSAGE}')"<!-- END: confirm -->>
{LANG.update}
</button>
...
<h3 style="font-size: 24px; margin-bottom: 20px; color: #17a2b8;">Thông tin thêm</h3>
<p style="font-size: 18px; margin-bottom: 10px;"><strong>ID thể loại:</strong> {CAT.id}</p>
<p style="font-size: 18px; margin-bottom: 10px;"><strong>Số sách:</strong> {CAT.book_count} cuốn</p>
<!-- BEGIN: has_books_warning -->
<div style="background: #fff3cd; color: #856404; padding: 15px; border: 2px solid #ffeaa7; border-radius: 8px; margin-top: 15px;">
